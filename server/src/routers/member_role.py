...
from src.schemas import MemberRoleSchema, MemberRoleSearchSchema, MemberRoleCreateSchema, MemberRoleUpdateSchema
...
async def create(
        data: MemberRoleCreateSchema, db: Session = Depends(get_db)
):
    """
    Create member_role
    :param data: Data
