...
from src.schemas import PaymentMethodSchema, PaymentMethodSearchSchema, PaymentMethodCreateSchema, PaymentMethodUpdateSchema
...
async def create(
        data: PaymentMethodCreateSchema, db: Session = Depends(get_db)
):
    """
