...
from src.schemas import FlightTypeSchema, FlightTypeSearchSchema, FlightTypeCreateSchema, FlightTypeUpdateSchema
...
async def create(
        data: FlightTypeCreateSchema, db: Session = Depends(get_db)
):
    """
    Create flight_type
    :param data: Data
