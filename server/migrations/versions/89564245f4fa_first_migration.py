...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['field_responsible_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['instruction_glider_id'], ['gliders.id'], ),
    sa.ForeignKeyConstraint(['responsible_cfi_id'], ['members.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_actions_id'), 'actions', ['id'], unique=False)
    op.create_table('gliders_owners',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('glider_id', sa.Integer(), nullable=False),
    sa.Column('member_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['glider_id'], ['gliders.id'], ),
    sa.ForeignKeyConstraint(['member_id'], ['members.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_gliders_owners_id'), 'gliders_owners', ['id'], unique=False)
    op.create_table('members_roles',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('member_id', sa.Integer(), nullable=False),
    ...
    op.create_table('active_tow_airplanes',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['airplane_id'], ['tow_airplanes.id'], ),
    sa.ForeignKeyConstraint(['tow_pilot_id'], ['members.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_active_tow_airplanes_id'), 'active_tow_airplanes', ['id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['action_id'], ['actions.id'], ),
    sa.ForeignKeyConstraint(['flight_type_id'], ['flight_types.id'], ),
    sa.ForeignKeyConstraint(['glider_id'], ['gliders.id'], ),
    sa.ForeignKeyConstraint(['payers_type_id'], ['payers_types.id'], ),
    sa.ForeignKeyConstraint(['paying_member_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['payment_method_id'], ['payment_methods.id'], ),
    sa.ForeignKeyConstraint(['payment_receiver_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['pilot_1_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['pilot_2_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['tow_airplane_id'], ['tow_airplanes.id'], ),
    sa.ForeignKeyConstraint(['tow_pilot_id'], ['members.id'], ),
    sa.ForeignKeyConstraint(['tow_type_id'], ['tow_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
