...
export const TEXTS = {
    ...
    SOLO_STUDENT_FLIGHT: "טיסת סולו לחניך",
    MEMBERS: "חברים",
    NAME: "שם",
    EMAIL: "דוא״ל",
    PHONE: "טלפון",
    ...
    TRAINING_FLIGHT: "טיסת הדרכה",
    SOLO_FLIGHT: "טיסת סולו",
    CHECK_FLIGHT: "טיסת מבחן",
    SELECT_FLIGHT_DETAILS: "בחר פרטי טיסה",
    NO_GLIDER_SELECTED: "לא נבחר דאון",
    REGULAR: "דאון רגיל",
    TOURING: "דאון טיורינג",
    CLUB_OWNED: "דאון מועדון",
    PRIVATE: "דאון פרטי",
    SEATS: "מושבים",
    INSTRUCTION: "הדרכה",
