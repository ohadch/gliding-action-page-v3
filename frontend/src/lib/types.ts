...
export type NotificationConfigSchema = components["schemas"]["NotificationConfigSchema"]
export type NotificationCreateSchema = components["schemas"]["NotificationCreateSchema"]
